...
<link rel="stylesheet" href="/custom_css/studenthome.css">
</head>
<style>
</style>
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8">
				<a href="#" class="btn btn-danger" id="logoutbtn"> <span
			...
			<div class="col-md-8 ">
				<form method="post">
					...
					<button type="submit" id="startexambtn"
						class="btn btn-block btn-success disabled" value="Start Exam"
						name="startexam">
